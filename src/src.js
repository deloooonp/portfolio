...
document.addEventListener('alpine:init', () => {
    Alpine.data('experiences', () => ({
        items: [
            { id: 1, name: 'Web Development Projects', date: '2023 - 2024', desc: 'During my college studies, I worked on several web development projects that showcase my skills in front-end and back-end development.' },
        ]
    }));
});
