...
>>>>>>> origin/main:src/windows/Terminal.jsx
...
=======
    <div className="text-sm font-roboto p-5 flex-1">
      <p>
        <span className="font-bold">@delon % </span>
        show tech stack
      </p>
...
const TerminalWindow = WindowWrapper(Terminal, "terminal", {
  title: "Tech Stack",
  className:
    "w-xl top-32 left-1/12 bg-white shadow-2xl drop-shadow-2xl rounded-xl overflow-hidden flex flex-col",
});
